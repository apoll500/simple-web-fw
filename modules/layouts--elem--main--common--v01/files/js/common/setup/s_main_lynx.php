...
for($i=1;$i<count($lines);$i++)
{
    ...
    else
    {
        ...
        {
            if($lines[$i]=="\$info" && isset($info))
                echo "$info<br>";
            else if($lines[$i]=="\$lang" && isset($lang))
                echo "$lang<br>";
            else if($lines[$i]=="\$page" && isset($page))
                echo "$page<br>";
            else if($lines[$i]=="\$next" && isset($next))
                echo "$next<br>";
        }
        //-----------------------------------
        //LIST
        ...
        //WINDOW
        //-----------------------------------
        elseif(mb_substr($lines[$i],0,7)=="WINDOW|")
        {
            $a=explode("|",$lines[$i]);
            if($a[2]=="treesel")
            {
                include("../js/elements/treesel/treesel_lynx.php");
            }
        }
        //-----------------------------------
        //HIDDEN

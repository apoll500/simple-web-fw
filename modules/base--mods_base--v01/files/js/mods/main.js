...
function get_all_forms_data()
{
    ...
    {
        var form_name=document.forms[i].attributes["name"].value;
...
{
    var prefix=context_make_prefix2(level);
    var v=main_handler.main_context.load2(prefix+name,default_value);
...
{
    for(var i=0;i<main_handler.main_context.container.length;i++)
    {
        var prefix=main_handler.main_context.container[i].filename.substr(0,4);
...
function caller_stack_push(module,table,token,data)
{
    ...
    //increase depath
    sub_depth++;
    main_handler.main_context.store("sub_depth",sub_depth);
    //store values
...
{
    //store values
    main_handler.main_context.store("global_stack_"+sub_depth+"_caller_module",module);
    main_handler.main_context.store("global_stack_"+sub_depth+"_caller_table",table);
    main_handler.main_context.store("global_stack_"+sub_depth+"_caller_token",token);
    main_handler.main_context.store("global_stack_"+sub_depth+"_caller_level",level);
    main_handler.main_context.store("global_stack_"+sub_depth+"_caller_level2",level2);
    if(Array.isArray(data))
    {
        for(var i=0;i<data.length;i++)
        {
            main_handler.main_context.store("global_stack_"+sub_depth+"_caller_data"+i,data[i]);
        }
        main_handler.main_context.store("global_stack_"+sub_depth+"_caller_data","");
    }
    else
    {
        main_handler.main_context.store("global_stack_"+sub_depth+"_caller_data",data);
    }
    //caller_stack_peek_print();
}
function caller_stack_pop()
{
    var sub_depth=caller_stack_depth();
    //delete items
    main_handler.main_context.del("global_stack_"+sub_depth+"_caller_module");
    main_handler.main_context.del("global_stack_"+sub_depth+"_caller_table");
    main_handler.main_context.del("global_stack_"+sub_depth+"_caller_token");
    main_handler.main_context.del("global_stack_"+sub_depth+"_caller_data");
    main_handler.main_context.del("global_stack_"+sub_depth+"_caller_level");
    main_handler.main_context.del("global_stack_"+sub_depth+"_caller_level2");
    var i=0;
    while(true)
    {
        if(!main_handler.main_context.del("global_stack_"+sub_depth+"_caller_data"+i))
        {
            break;
        }
        i++;
...
function caller_stack_clear()
{
    ...
    {
        main_handler.main_context.del("global_stack_"+sd+"_caller_module");
        main_handler.main_context.del("global_stack_"+sd+"_caller_table");
        main_handler.main_context.del("global_stack_"+sd+"_caller_token");
        main_handler.main_context.del("global_stack_"+sd+"_caller_data");
        main_handler.main_context.del("global_stack_"+sd+"_caller_level");
        main_handler.main_context.del("global_stack_"+sd+"_caller_level2");
        var i=0;
        while(true)
        {
            if(!main_handler.main_context.del("global_stack_"+sd+"_caller_data"+i))
            {
                break;
            }
            i++;
    ...
    //reset depth
    main_handler.main_context.store("sub_depth",0);
}
...
{
    var sub_depth=parseInt(main_handler.main_context.load2("sub_depth","0"));
    return sub_depth;
}
...
{
    var module=main_handler.main_context.load("global_stack_"+sub_depth+"_caller_module");
    return module;
}
function caller_stack_peek_table2(sub_depth)
{
    var module=main_handler.main_context.load("global_stack_"+sub_depth+"_caller_table");
    return module;
}
function caller_stack_peek_token2(sub_depth)
{
    var token=main_handler.main_context.load("global_stack_"+sub_depth+"_caller_token");
    return token;
}
function caller_stack_peek_data2(sub_depth)
{
    var data=main_handler.main_context.load("global_stack_"+sub_depth+"_caller_data");
    if(data=="")
    {
        var i=0;
        var d=[];
        while(true)
        {
            var di=main_handler.main_context.load2("global_stack_"+sub_depth+"_caller_data"+i,"undefined");
...
{
    var token=main_handler.main_context.load("global_stack_"+sub_depth+"_caller_level");
    return token;
}
function caller_stack_peek_level22(sub_depth)
{
    var token=main_handler.main_context.load("global_stack_"+sub_depth+"_caller_level2");
    return token;
}
/*******************************************************************************
*                                                                              *
...
function dump()
{
    ...
    main_handler.main_context.print();
    console.log("------------------------------------------------");
}

...
//------------------------------------------------------------------------------
/*
function handler_save(handler,dom_element,module,evt,type,context)
{
    if(typeof domel[dom_element].object.title == 'undefined')var elem=domel[dom_element].object.box;
    else var elem=domel[dom_element].object.title;
    ...
    {
        console.log("main.js - save: "+evt);
        new sysmod_box("main.js - "+type+":<hr>Fehlermeldung:<br>"+evt);
    }
}

function handler_reply(handler,dom_element,module,evt,type,context)
{
    if(typeof domel[dom_element].object.title == 'undefined')var elem=domel[dom_element].object.box;
    else var elem=domel[dom_element].object.title;
    ...
    else if(part[0]=="[E208]")
    {
        ...
        elem.insertBefore(d,elem.firstChild);
        main_handler.loadText("text","user_txt_pass_diff");
    }
    else if(part[0]=="[E206]")
    {
        var d=document.createElement("div");
        ...
        d.innerHTML="Error: "+evt;
        elem.insertBefore(d,elem.firstChild);
        main_handler.loadText("text","user_txt_short_pass");
    }
    else if(part[0]=="[E209]")
    {
        var d=document.createElement("div");
        ...
        d.innerHTML="Error: "+evt;
        elem.insertBefore(d,elem.firstChild);
        main_handler.loadText("text","user_txt_false_pass");
    }
    else
    {
        var d=document.createElement("div");
...
*/
/*
function handler_memshow(handler,dom_element,module,evt,type,context)
{
    var part=evt.split("|");
    if(part[0]=="[OK]")
    {
        ...
        {
            //console.log("memshow: dataevent not ready");
        }
    }
    else
    {
        //no_login
        main_handler.gotopage=currentpage;
        mods_user_load("login");
        //main_handler.gotopage=context;
    }
}
*/
/*
function handler_memshow_admin(handler,dom_element,module,evt,type,context)
{
    var part=evt.split("|");
    if(part[0]=="[OK]")
    {
...
function handler_memshow_developer(handler,dom_element,module,evt,type,context)
{
    var part=evt.split("|");
    if(part[0]=="[OK]")
    {
        ...
        {
            //no_developer
            mods_user_load("nodeveloper");
            //load_page("mod_user_nodeveloper");
        }
    }
    else
    {
...
function handler_handle_search_results(handler,module,evt,type,context,data,part)
{
    ...
    if(document.getElementById("dcontent_"+dcontext+"1"))
        new results_nav_wrapper(document.getElementById("dcontent_"+dcontext+"1"),gstyle,null,formular).setup_data(vars);
    if(document.getElementById("dcontent_"+dcontext+"3"))
        new results_nav_wrapper(document.getElementById("dcontent_"+dcontext+"3"),gstyle,null,formular).setup_data(vars);
...
/*
function handler_handle_search_results_bottom(handler,module,evt,type,context,data,part)
{
    var a=(data+",,").split(",");
    var formular=a[0];
    var listname=a[1];
...
//------------------------------------------------------------------------------
/*
function fill_form(module,evt,type,context,formular)
{
    var part=evt.split("|");
    if(part[0]=="[OK]")
    {
    ...
    else if(part[0]=="[E103]")//no_data
    {
        console.log(module+"::fill_form() - no data: "+evt);
        new sysmod_box(module+"::fill_form() - "+type+":<hr>Fehlermeldung:<br>"+evt);
    }
    else if(part[0]=="[E105]")//no_login
    {
        mods_user_load("login");
        main_handler.gotopage=context;//type+"|"+module;
    }
    else
    {
        console.log(module+"::fill_form() - unknown part[0]: "+evt);
        new sysmod_box(module+"::fill_form() - "+type+":<hr>Fehlermeldung:<br>"+evt);
    }
}
*/
function fill_form_i(module,parti,type,context,formular,do_enable_fields)
{
    ...
    //
    e_mbox.check_inputs2(module);
}

//(1)---------------------------------------------------------------------------
// handler function callers
//------------------------------------------------------------------------------
/*
function handler_run_rdata(handler,module,evt,type,context,data,func)
{
    var part=evt.split("|");
    switch(part[0])
    {
        case "[OK]":
            if(dataevent_store2(type,context,module,evt))
            {
                func(handler,module,evt,type,context,data,part);
                return true;
            }
            break;
        case "[E103]"://no_data
